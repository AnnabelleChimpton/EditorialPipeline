...
- **Topic ID**: e.g., `vce-006`
- **Target format**: one of — narrative long-post, ranked list, "remember when" thread, hot take + receipts, visual carousel, before/after comparison, mini-essay
...
Example: `REFERENCE/drafts/vce-006-topic-slug-thread.md`

Append an entry to `REFERENCE/dossier-index.jsonl`:
```json
{"id":"vce-006","type":"draft","format":"thread","draft":"REFERENCE/drafts/vce-006-topic-slug-thread.md","note":"reformat from longpost","timestamp":"..."}
```
