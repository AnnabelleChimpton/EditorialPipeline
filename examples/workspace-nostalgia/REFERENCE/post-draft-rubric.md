...
## Voice rules
The draft must NOT:
- Open with "In the early 2000s..." or any era-setting throat-clear
- Use "iconic," "legendary," "game-changing," or "revolutionary" unironically
...
- If the brief specifies comedy-first tone, let the humor carry the piece — the argument can be implicit rather than stated. Don't force an analytical pivot if the comedy is doing the work.
- End with one of: a resonant image or scene, a person's words (quote getting the last word), a question left genuinely open, a punchline that IS the point, or a thesis restatement. Check the last 3 drafts in `REFERENCE/drafts/` — if they all used the same closing type, use a different one.
